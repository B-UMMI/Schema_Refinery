...
Purpose
-------
This script serves to analyse assemblies generated from a
pipeline like Innuca and create a report based on that
analysis.
Code documentation
------------------
"""
...
def guess_file_compression(file_path, magic_dict=None):
    """ Determines the compression of an input file.
...
def check_if_list_or_folder(folder_or_list):
    """ Checks if a path represents a file or a directory.
    Parameters
    ----------
    folder_or_list : str
