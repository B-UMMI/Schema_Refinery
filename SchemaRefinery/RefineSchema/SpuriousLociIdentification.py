...
def main(schema, output_directory, allelecall_directory, alignment_ratio_threshold, pident_threshold, clustering_sim, clustering_cov, cpu):
    ...
    if allelecall_directory:
        ...
        gene_fusions.main(schema, gene_fusions_output, allelecall_directory, clustering_sim, clustering_cov, cpu)